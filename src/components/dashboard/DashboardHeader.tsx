import { Search, Bell, ChevronDown, Shield, Sun, Moon } from "lucide-react";
  ...
  return (
    <header className="sticky top-0 z-30 epi-glass-card border-b border-border">
      <div className="flex items-center gap-4 px-6 py-3">
        ...
        <button
          onClick={toggleTheme}
          className="p-2 rounded-xl border border-border bg-card hover:bg-[var(--hover-bg)] transition-all"
        ...
        {/* Notification bell */}
        <button className="relative p-2 rounded-xl hover:bg-[var(--hover-bg)] transition-colors" aria-label="Notifications">
        ...
        {/* User Avatar */}
        <button className="flex items-center gap-2 p-1.5 rounded-xl hover:bg-[var(--hover-bg)] transition-colors">
